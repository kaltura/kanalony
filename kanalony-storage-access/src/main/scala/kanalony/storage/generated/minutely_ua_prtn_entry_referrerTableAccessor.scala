...
object value extends LongColumn(this)
  ...
  def fromRow(row: Row): minutely_ua_prtn_entry_referrerRow = {
    minutely_ua_prtn_entry_referrerRow(
      partner_id(row), 
entry_id(row), 
referrer(row), 
metric(row), 
...
value(row)
  ...
  def store(entity: minutely_ua_prtn_entry_referrerRow): Future[ResultSet] = {
