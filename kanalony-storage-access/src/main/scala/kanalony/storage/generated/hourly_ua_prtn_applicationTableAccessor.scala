...
object value extends LongColumn(this)
  ...
  override def tableName = "hourly_ua_prtn_application"

  def fromRow(row: Row): hourly_ua_prtn_applicationRow = {
    hourly_ua_prtn_applicationRow(
      partner_id(row), 
application(row), 
metric(row), 
year(row), 
...
value(row)
  ...
  def store(entity: hourly_ua_prtn_applicationRow): Future[ResultSet] = {
