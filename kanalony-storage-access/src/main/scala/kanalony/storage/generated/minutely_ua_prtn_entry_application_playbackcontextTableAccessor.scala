...
.value(_.value, entity.value)
  ...
  def query(partner_id : Int, entry_id : String, application : String, playbackContext : String, metric : Int) : SelectQuery[minutely_ua_prtn_entry_application_playbackcontextTableAccessor, minutely_ua_prtn_entry_application_playbackcontextRow, Unlimited, Unordered, Unspecified, Chainned] = {
