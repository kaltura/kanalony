...
.value(_.value, entity.value)
  ...
  def query(partner_id : Int, entry_id : String, metric : Int, country : String, city : String, year : Int) : SelectQuery[hourly_ua_prtn_entry_country_cityTableAccessor, hourly_ua_prtn_entry_country_cityRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
...
.and(_.year eqs year)
 ...
 def query(partner_id : Int, entry_id : String, metric : Int, country : String, city : String, year : Int, hourStart : DateTime, hourEnd : DateTime) : SelectQuery[hourly_ua_prtn_entry_country_cityTableAccessor, hourly_ua_prtn_entry_country_cityRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partner_id).and(_.entry_id eqs entry_id)
.and(_.metric eqs metric)
.and(_.country eqs country)
.and(_.city eqs city)
...
def query(partner_id_list : List[Int], entry_id_list : List[String], metric_list : List[Int], country_list : List[String], city_list : List[String], year_list : List[Int]) : SelectQuery[hourly_ua_prtn_entry_country_cityTableAccessor, hourly_ua_prtn_entry_country_cityRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
