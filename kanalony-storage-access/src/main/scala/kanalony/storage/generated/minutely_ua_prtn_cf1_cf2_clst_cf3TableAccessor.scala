...
object value extends LongColumn(this)
  ...
  override def tableName = "minutely_ua_prtn_cf1_cf2_clst_cf3"

  def fromRow(row: Row): minutely_ua_prtn_cf1_cf2_clst_cf3Row = {
    minutely_ua_prtn_cf1_cf2_clst_cf3Row(
      partner_id(row), 
cf1(row), 
cf2(row), 
metric(row), 
...
value(row)
  ...
  def store(entity: minutely_ua_prtn_cf1_cf2_clst_cf3Row): Future[ResultSet] = {
