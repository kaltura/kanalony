...
.value(_.value, entity.value)
  ...
  def query(partner_id : Int, application : String, metric : Int, year : Int) : SelectQuery[hourly_ua_ptrn_application_clst_playbackcontextTableAccessor, hourly_ua_ptrn_application_clst_playbackcontextRow, Unlimited, Unordered, Unspecified, Chainned] = {
    select.where(_.partner_id eqs partner_id).and(_.application eqs application)
.and(_.metric eqs metric)
.and(_.year eqs year)
  }
 def query(partner_id : Int, application : String, metric : Int, year : Int, hourStart : DateTime, hourEnd : DateTime) : SelectQuery[hourly_ua_ptrn_application_clst_playbackcontextTableAccessor, hourly_ua_ptrn_application_clst_playbackcontextRow, Unlimited, Unordered, Unspecified, Chainned] = {
    select.where(_.partner_id eqs partner_id).and(_.application eqs application)
.and(_.metric eqs metric)
.and(_.year eqs year)
...
def query(partner_id_list : List[Int], application_list : List[String], metric_list : List[Int], year_list : List[Int]) : SelectQuery[hourly_ua_ptrn_application_clst_playbackcontextTableAccessor, hourly_ua_ptrn_application_clst_playbackcontextRow, Unlimited, Unordered, Unspecified, Chainned] = {
