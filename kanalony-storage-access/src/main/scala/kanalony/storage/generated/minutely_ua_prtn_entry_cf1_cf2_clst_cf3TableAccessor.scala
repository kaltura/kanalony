...
.value(_.value, entity.value)
  ...
  def query(partner_id : Int, entry_id : String, cf1 : String, cf2 : String, metric : Int) : SelectQuery[minutely_ua_prtn_entry_cf1_cf2_clst_cf3TableAccessor, minutely_ua_prtn_entry_cf1_cf2_clst_cf3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partner_id).and(_.entry_id eqs entry_id)
.and(_.cf1 eqs cf1)
.and(_.cf2 eqs cf2)
.and(_.metric eqs metric)
  }
 def query(partner_id : Int, entry_id : String, cf1 : String, cf2 : String, metric : Int, minuteStart : DateTime, minuteEnd : DateTime) : SelectQuery[minutely_ua_prtn_entry_cf1_cf2_clst_cf3TableAccessor, minutely_ua_prtn_entry_cf1_cf2_clst_cf3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partner_id).and(_.entry_id eqs entry_id)
.and(_.cf1 eqs cf1)
.and(_.cf2 eqs cf2)
.and(_.metric eqs metric)
...
.and(_.minute lt minuteEnd)
 ...
 def query(partner_id : Int, entry_id : String, cf1 : String, cf2 : String, metric : Int, minuteStart : DateTime, minuteEnd : DateTime, cf3Start : String, cf3End : String) : SelectQuery[minutely_ua_prtn_entry_cf1_cf2_clst_cf3TableAccessor, minutely_ua_prtn_entry_cf1_cf2_clst_cf3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partner_id).and(_.entry_id eqs entry_id)
.and(_.cf1 eqs cf1)
.and(_.cf2 eqs cf2)
.and(_.metric eqs metric)
...
def query(partner_id_list : List[Int], entry_id_list : List[String], cf1_list : List[String], cf2_list : List[String], metric_list : List[Int]) : SelectQuery[minutely_ua_prtn_entry_cf1_cf2_clst_cf3TableAccessor, minutely_ua_prtn_entry_cf1_cf2_clst_cf3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
