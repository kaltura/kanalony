...
object value extends LongColumn(this)
  ...
  override def tableName = "minutely_ua_clst_playbackcontext"

  def fromRow(row: Row): minutely_ua_clst_playbackcontextRow = {
    minutely_ua_clst_playbackcontextRow(
      partner_id(row), 
metric(row), 
minute(row), 
playbackContext(row), 
value(row)
  ...
  def store(entity: minutely_ua_clst_playbackcontextRow): Future[ResultSet] = {
