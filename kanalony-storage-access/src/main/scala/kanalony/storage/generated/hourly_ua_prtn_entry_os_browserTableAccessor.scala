...
.value(_.value, entity.value)
  ...
  def query(partner_id : Int, entry_id : String, os : String, browser : String, metric : Int, year : Int) : SelectQuery[hourly_ua_prtn_entry_os_browserTableAccessor, hourly_ua_prtn_entry_os_browserRow, Unlimited, Unordered, Unspecified, Chainned] = {
...
.and(_.year eqs year)
 ...
 def query(partner_id : Int, entry_id : String, os : String, browser : String, metric : Int, year : Int, hourStart : DateTime, hourEnd : DateTime) : SelectQuery[hourly_ua_prtn_entry_os_browserTableAccessor, hourly_ua_prtn_entry_os_browserRow, Unlimited, Unordered, Unspecified, Chainned] = {
    select.where(_.partner_id eqs partner_id).and(_.entry_id eqs entry_id)
.and(_.os eqs os)
.and(_.browser eqs browser)
.and(_.metric eqs metric)
...
def query(partner_id_list : List[Int], entry_id_list : List[String], os_list : List[String], browser_list : List[String], metric_list : List[Int], year_list : List[Int]) : SelectQuery[hourly_ua_prtn_entry_os_browserTableAccessor, hourly_ua_prtn_entry_os_browserRow, Unlimited, Unordered, Unspecified, Chainned] = {
