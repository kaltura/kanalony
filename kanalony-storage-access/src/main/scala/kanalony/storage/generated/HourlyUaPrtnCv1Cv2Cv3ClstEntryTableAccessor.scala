...
.value(_.value, entity.value)
  ...
  def query(partnerId : Int, customVar1 : String, customVar2 : String, customVar3 : String, year : Int, metric : Int) : SelectQuery[HourlyUaPrtnCv1Cv2Cv3ClstEntryTableAccessor, HourlyUaPrtnCv1Cv2Cv3ClstEntryRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
...
.and(_.metric eqs metric)
 ...
 def query(partnerId : Int, customVar1 : String, customVar2 : String, customVar3 : String, year : Int, metric : Int, hourStart : DateTime, hourEnd : DateTime) : SelectQuery[HourlyUaPrtnCv1Cv2Cv3ClstEntryTableAccessor, HourlyUaPrtnCv1Cv2Cv3ClstEntryRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partnerId).and(_.custom_var1 eqs customVar1)
.and(_.custom_var2 eqs customVar2)
.and(_.custom_var3 eqs customVar3)
.and(_.year eqs year)
...
def query(partnerIdList : List[Int], customVar1List : List[String], customVar2List : List[String], customVar3List : List[String], yearList : List[Int], metricList : List[Int]) : SelectQuery[HourlyUaPrtnCv1Cv2Cv3ClstEntryTableAccessor, HourlyUaPrtnCv1Cv2Cv3ClstEntryRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
