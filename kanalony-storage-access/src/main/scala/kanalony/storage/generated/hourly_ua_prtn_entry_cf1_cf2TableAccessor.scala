...
.value(_.value, entity.value)
  ...
  def query(partner_id : Int, entry_id : String, cf1 : String, cf2 : String, metric : Int, year : Int) : SelectQuery[hourly_ua_prtn_entry_cf1_cf2TableAccessor, hourly_ua_prtn_entry_cf1_cf2Row, Unlimited, Unordered, Unspecified, Chainned] = {
...
.and(_.year eqs year)
 ...
 def query(partner_id : Int, entry_id : String, cf1 : String, cf2 : String, metric : Int, year : Int, hourStart : DateTime, hourEnd : DateTime) : SelectQuery[hourly_ua_prtn_entry_cf1_cf2TableAccessor, hourly_ua_prtn_entry_cf1_cf2Row, Unlimited, Unordered, Unspecified, Chainned] = {
    select.where(_.partner_id eqs partner_id).and(_.entry_id eqs entry_id)
.and(_.cf1 eqs cf1)
.and(_.cf2 eqs cf2)
.and(_.metric eqs metric)
...
def query(partner_id_list : List[Int], entry_id_list : List[String], cf1_list : List[String], cf2_list : List[String], metric_list : List[Int], year_list : List[Int]) : SelectQuery[hourly_ua_prtn_entry_cf1_cf2TableAccessor, hourly_ua_prtn_entry_cf1_cf2Row, Unlimited, Unordered, Unspecified, Chainned] = {
