...
.value(_.value, entity.value)
  ...
  def query(partnerId : Int, customVar1 : String, entryId : String, customVar2 : String, customVar3 : String, year : Int, metric : Int) : SelectQuery[HourlyUaPrtnEntryCv1Cv2Cv3TableAccessor, HourlyUaPrtnEntryCv1Cv2Cv3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
...
.and(_.metric eqs metric)
 ...
 def query(partnerId : Int, customVar1 : String, entryId : String, customVar2 : String, customVar3 : String, year : Int, metric : Int, hourStart : DateTime, hourEnd : DateTime) : SelectQuery[HourlyUaPrtnEntryCv1Cv2Cv3TableAccessor, HourlyUaPrtnEntryCv1Cv2Cv3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partnerId).and(_.custom_var1 eqs customVar1)
.and(_.entry_id eqs entryId)
.and(_.custom_var2 eqs customVar2)
.and(_.custom_var3 eqs customVar3)
...
def query(partnerIdList : List[Int], customVar1List : List[String], entryIdList : List[String], customVar2List : List[String], customVar3List : List[String], yearList : List[Int], metricList : List[Int]) : SelectQuery[HourlyUaPrtnEntryCv1Cv2Cv3TableAccessor, HourlyUaPrtnEntryCv1Cv2Cv3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
...
.and(_.metric in metricList)
 ...
 def query(partnerIdList : List[Int], customVar1List : List[String], entryIdList : List[String], customVar2List : List[String], customVar3List : List[String], yearList : List[Int], metricList : List[Int], hourStart : DateTime, hourEnd : DateTime) : SelectQuery[HourlyUaPrtnEntryCv1Cv2Cv3TableAccessor, HourlyUaPrtnEntryCv1Cv2Cv3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id in partnerIdList).and(_.custom_var1 in customVar1List)
.and(_.entry_id in entryIdList)
.and(_.custom_var2 in customVar2List)
.and(_.custom_var3 in customVar3List)
