...
.value(_.value, entity.value)
  ...
  def query(partner_id : Int, entry_id : String, application : String, metric : Int, year : Int) : SelectQuery[minutely_ua_prtn_entry_application_clst_playbackcontextTableAccessor, minutely_ua_prtn_entry_application_clst_playbackcontextRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partner_id).and(_.entry_id eqs entry_id)
.and(_.application eqs application)
.and(_.metric eqs metric)
.and(_.year eqs year)
  }
 def query(partner_id : Int, entry_id : String, application : String, metric : Int, year : Int, minuteStart : DateTime, minuteEnd : DateTime) : SelectQuery[minutely_ua_prtn_entry_application_clst_playbackcontextTableAccessor, minutely_ua_prtn_entry_application_clst_playbackcontextRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partner_id).and(_.entry_id eqs entry_id)
.and(_.application eqs application)
.and(_.metric eqs metric)
.and(_.year eqs year)
...
def query(partner_id_list : List[Int], entry_id_list : List[String], application_list : List[String], metric_list : List[Int], year_list : List[Int]) : SelectQuery[minutely_ua_prtn_entry_application_clst_playbackcontextTableAccessor, minutely_ua_prtn_entry_application_clst_playbackcontextRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
