...
.value(_.value, entity.value)
  ...
  def query(partnerId : Int, application : String, playbackContext : String, metric : Int) : SelectQuery[MinutelyUaPrtnAppPlaybackContextClstEntryTableAccessor, MinutelyUaPrtnAppPlaybackContextClstEntryRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partnerId).and(_.application eqs application)
.and(_.playback_context eqs playbackContext)
.and(_.metric eqs metric)
  }
 def query(partnerId : Int, application : String, playbackContext : String, metric : Int, minuteStart : DateTime, minuteEnd : DateTime) : SelectQuery[MinutelyUaPrtnAppPlaybackContextClstEntryTableAccessor, MinutelyUaPrtnAppPlaybackContextClstEntryRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partnerId).and(_.application eqs application)
.and(_.playback_context eqs playbackContext)
.and(_.metric eqs metric)
...
def query(partnerIdList : List[Int], applicationList : List[String], playbackContextList : List[String], metricList : List[Int]) : SelectQuery[MinutelyUaPrtnAppPlaybackContextClstEntryTableAccessor, MinutelyUaPrtnAppPlaybackContextClstEntryRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
...
.and(_.metric in metricList)
 ...
 def query(partnerIdList : List[Int], applicationList : List[String], playbackContextList : List[String], metricList : List[Int], minuteStart : DateTime, minuteEnd : DateTime) : SelectQuery[MinutelyUaPrtnAppPlaybackContextClstEntryTableAccessor, MinutelyUaPrtnAppPlaybackContextClstEntryRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id in partnerIdList).and(_.application in applicationList)
.and(_.playback_context in playbackContextList)
.and(_.metric in metricList)
.and(_.minute gte minuteStart)
