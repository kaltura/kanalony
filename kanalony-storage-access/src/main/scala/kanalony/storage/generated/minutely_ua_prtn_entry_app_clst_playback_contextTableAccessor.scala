...
.value(_.value, entity.value)
  ...
  def query(partner_id : Int, entry_id : String, application : String, year : Int) : SelectQuery[minutely_ua_prtn_entry_app_clst_playback_contextTableAccessor, minutely_ua_prtn_entry_app_clst_playback_contextRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partner_id).and(_.entry_id eqs entry_id)
.and(_.application eqs application)
.and(_.year eqs year)
  }
 def query(partner_id : Int, entry_id : String, application : String, year : Int, minuteStart : DateTime, minuteEnd : DateTime) : SelectQuery[minutely_ua_prtn_entry_app_clst_playback_contextTableAccessor, minutely_ua_prtn_entry_app_clst_playback_contextRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partner_id).and(_.entry_id eqs entry_id)
.and(_.application eqs application)
.and(_.year eqs year)
...
def query(partner_id_list : List[Int], entry_id_list : List[String], application_list : List[String], year_list : List[Int]) : SelectQuery[minutely_ua_prtn_entry_app_clst_playback_contextTableAccessor, minutely_ua_prtn_entry_app_clst_playback_contextRow, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
