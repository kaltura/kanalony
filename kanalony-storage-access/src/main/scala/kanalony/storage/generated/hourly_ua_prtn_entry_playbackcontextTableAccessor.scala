...
.value(_.value, entity.value)
  ...
  def query(partner_id : Int, entry_id : String, playbackContext : String, metric : Int, year : Int) : SelectQuery[hourly_ua_prtn_entry_playbackcontextTableAccessor, hourly_ua_prtn_entry_playbackcontextRow, Unlimited, Unordered, Unspecified, Chainned] = {
    select.where(_.partner_id eqs partner_id).and(_.entry_id eqs entry_id)
.and(_.playbackContext eqs playbackContext)
.and(_.metric eqs metric)
.and(_.year eqs year)
  }
 def query(partner_id : Int, entry_id : String, playbackContext : String, metric : Int, year : Int, hourStart : DateTime, hourEnd : DateTime) : SelectQuery[hourly_ua_prtn_entry_playbackcontextTableAccessor, hourly_ua_prtn_entry_playbackcontextRow, Unlimited, Unordered, Unspecified, Chainned] = {
    select.where(_.partner_id eqs partner_id).and(_.entry_id eqs entry_id)
.and(_.playbackContext eqs playbackContext)
.and(_.metric eqs metric)
.and(_.year eqs year)
...
def query(partner_id_list : List[Int], entry_id_list : List[String], playbackContext_list : List[String], metric_list : List[Int], year_list : List[Int]) : SelectQuery[hourly_ua_prtn_entry_playbackcontextTableAccessor, hourly_ua_prtn_entry_playbackcontextRow, Unlimited, Unordered, Unspecified, Chainned] = {
