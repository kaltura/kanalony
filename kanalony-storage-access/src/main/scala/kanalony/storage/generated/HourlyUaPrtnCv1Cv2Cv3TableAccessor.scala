...
.value(_.value, entity.value)
  ...
  def query(partnerId : Int, customVar1 : String, customVar2 : String, customVar3 : String, metric : Int, year : Int) : SelectQuery[HourlyUaPrtnCv1Cv2Cv3TableAccessor, HourlyUaPrtnCv1Cv2Cv3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
...
.and(_.year eqs year)
 ...
 def query(partnerId : Int, customVar1 : String, customVar2 : String, customVar3 : String, metric : Int, year : Int, hourStart : DateTime, hourEnd : DateTime) : SelectQuery[HourlyUaPrtnCv1Cv2Cv3TableAccessor, HourlyUaPrtnCv1Cv2Cv3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partnerId).and(_.custom_var1 eqs customVar1)
.and(_.custom_var2 eqs customVar2)
.and(_.custom_var3 eqs customVar3)
.and(_.metric eqs metric)
...
def query(partnerIdList : List[Int], customVar1List : List[String], customVar2List : List[String], customVar3List : List[String], metricList : List[Int], yearList : List[Int]) : SelectQuery[HourlyUaPrtnCv1Cv2Cv3TableAccessor, HourlyUaPrtnCv1Cv2Cv3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
