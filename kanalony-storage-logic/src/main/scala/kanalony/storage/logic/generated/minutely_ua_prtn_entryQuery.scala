package kanalony.storage.logic.generated
    ...
    class minutely_ua_prtn_entryQuery extends QueryBase[minutely_ua_prtn_entryQueryParams, minutely_ua_prtn_entryRow] with UserActivityQuery {
      ...
      private[logic] override def executeQuery(params: minutely_ua_prtn_entryQueryParams): Future[List[minutely_ua_prtn_entryRow]] = {
        val rawQueryResult = minutely_ua_prtn_entryTableAccessor.query(params.partner_id_list,params.entry_id_list,params.days,params.metric_list,params.startTime,params.endTime)
...
case class minutely_ua_prtn_entryQueryParams(startTime : DateTime, endTime : DateTime, partner_id_list : List[Int], entry_id_list : List[String], metric_list : List[Int]) extends IDailyPartitionedQueryParams