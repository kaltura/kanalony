package kanalony.storage.logic.generated
    ...
    class HourlyUaPrtnEntryCv1Cv2Cv3Query extends QueryBase[HourlyUaPrtnEntryCv1Cv2Cv3QueryParams, HourlyUaPrtnEntryCv1Cv2Cv3Row] with UserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): HourlyUaPrtnEntryCv1Cv2Cv3QueryParams = {
        ...
        HourlyUaPrtnEntryCv1Cv2Cv3QueryParams(params.start, params.end, partner_id,entry_id,custom_var1,custom_var2,custom_var3, params.metrics.map(_.id))
      }
      ...
      private[logic] override def executeQuery(params: HourlyUaPrtnEntryCv1Cv2Cv3QueryParams): Future[List[HourlyUaPrtnEntryCv1Cv2Cv3Row]] = {
        val rawQueryResult = HourlyUaPrtnEntryCv1Cv2Cv3TableAccessor.query(params.partnerIdList,params.entryIdList,params.customVar1List,params.customVar2List,params.customVar3List,params.metricList,params.years,params.startTime,params.endTime)
    ...
    rawQueryResult
      ...
      override protected def getResultRow(row: HourlyUaPrtnEntryCv1Cv2Cv3Row): List[String] = {
        List(row.partnerId.toString,row.entryId.toString,row.customVar1.toString,row.customVar2.toString,row.customVar3.toString,row.metric.toString,row.hour.toString,row.value.toString)
      }
...
case class HourlyUaPrtnEntryCv1Cv2Cv3QueryParams(startTime : DateTime, endTime : DateTime, partnerIdList : List[Int], entryIdList : List[String], customVar1List : List[String], customVar2List : List[String], customVar3List : List[String], metricList : List[Int]) extends IYearlyPartitionedQueryParams