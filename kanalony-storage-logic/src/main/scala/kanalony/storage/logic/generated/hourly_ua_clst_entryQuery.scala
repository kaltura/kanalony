package kanalony.storage.logic.generated
    ...
    class hourly_ua_clst_entryQuery extends QueryBase[hourly_ua_clst_entryQueryParams, hourly_ua_clst_entryRow] with UserActivityQuery {
      ...
      private[logic] override def executeQuery(params: hourly_ua_clst_entryQueryParams): Future[List[hourly_ua_clst_entryRow]] = {
        val rawQueryResult = hourly_ua_clst_entryTableAccessor.query(params.partner_id_list,params.metric_list,params.months,params.startTime,params.endTime)
...
case class hourly_ua_clst_entryQueryParams(startTime : DateTime, endTime : DateTime, partner_id_list : List[Int], metric_list : List[Int]) extends IMonthlyPartitionedQueryParams