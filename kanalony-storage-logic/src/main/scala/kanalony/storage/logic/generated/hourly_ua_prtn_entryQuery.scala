package kanalony.storage.logic.generated
    ...
    class hourly_ua_prtn_entryQuery extends QueryBase[hourly_ua_prtn_entryQueryParams, hourly_ua_prtn_entryRow] with UserActivityQuery {
      ...
      private[logic] override def executeQuery(params: hourly_ua_prtn_entryQueryParams): Future[List[hourly_ua_prtn_entryRow]] = {
        val rawQueryResult = hourly_ua_prtn_entryTableAccessor.query(params.partner_id_list,params.entry_id_list,params.metric_list,params.months,params.startTime,params.endTime)
...
case class hourly_ua_prtn_entryQueryParams(startTime : DateTime, endTime : DateTime, partner_id_list : List[Int], entry_id_list : List[String], metric_list : List[Int]) extends IMonthlyPartitionedQueryParams