package kanalony.storage.logic.generated
    ...
    class HourlyUaPrtnCv1Cv2ClstEntryQuery extends QueryBase[HourlyUaPrtnCv1Cv2ClstEntryQueryParams, HourlyUaPrtnCv1Cv2ClstEntryRow] with UserActivityQuery {
      ...
      private[logic] override def executeQuery(params: HourlyUaPrtnCv1Cv2ClstEntryQueryParams): Future[List[HourlyUaPrtnCv1Cv2ClstEntryRow]] = {
        val rawQueryResult = HourlyUaPrtnCv1Cv2ClstEntryTableAccessor.query(params.partnerIdList,params.customVar1List,params.customVar2List,params.years,params.metricList,params.startTime,params.endTime)
...
case class HourlyUaPrtnCv1Cv2ClstEntryQueryParams(startTime : DateTime, endTime : DateTime, partnerIdList : List[Int], customVar1List : List[String], customVar2List : List[String], metricList : List[Int]) extends IYearlyPartitionedQueryParams