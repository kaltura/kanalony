...
abstract class HourlyUaPrtnCv1Cv2TableAccessor extends CassandraTable[HourlyUaPrtnCv1Cv2TableAccessor, HourlyUaPrtnCv1Cv2Row] with RootConnector {
...
object value extends LongColumn(this)
  ...
  def fromRow(row: Row): HourlyUaPrtnCv1Cv2Row = {
    HourlyUaPrtnCv1Cv2Row(
      partner_id(row), 
custom_var1(row), 
custom_var2(row), 
year(row), 
...
value(row)
  ...
  def store(entity: HourlyUaPrtnCv1Cv2Row): Future[ResultSet] = {
