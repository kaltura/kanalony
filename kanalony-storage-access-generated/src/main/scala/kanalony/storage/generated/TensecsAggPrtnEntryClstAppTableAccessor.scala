...
object value extends LongColumn(this)
  ...
  override def tableName = "tensecs_agg_prtn_entry_clst_app"

  def fromRow(row: Row): TensecsAggPrtnEntryClstAppRow = {
    TensecsAggPrtnEntryClstAppRow(
      partner_id(row), 
entry_id(row), 
metric(row), 
day(row), 
...
value(row)
  ...
  def store(entity: TensecsAggPrtnEntryClstAppRow): Future[ResultSet] = {
