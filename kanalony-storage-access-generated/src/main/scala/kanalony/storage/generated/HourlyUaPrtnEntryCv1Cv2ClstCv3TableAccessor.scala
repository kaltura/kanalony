...
.value(_.value, entity.value)
  ...
  def query(partnerId : Int, entryId : String, customVar1 : String, customVar2 : String, year : Int, metric : Int) : SelectQuery[HourlyUaPrtnEntryCv1Cv2ClstCv3TableAccessor, HourlyUaPrtnEntryCv1Cv2ClstCv3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
...
.and(_.metric eqs metric)
 ...
 def query(partnerId : Int, entryId : String, customVar1 : String, customVar2 : String, year : Int, metric : Int, hourStart : DateTime, hourEnd : DateTime) : SelectQuery[HourlyUaPrtnEntryCv1Cv2ClstCv3TableAccessor, HourlyUaPrtnEntryCv1Cv2ClstCv3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
    select.where(_.partner_id eqs partnerId).and(_.entry_id eqs entryId)
.and(_.custom_var1 eqs customVar1)
.and(_.custom_var2 eqs customVar2)
.and(_.year eqs year)
...
def query(partnerIdList : List[Int], entryIdList : List[String], customVar1List : List[String], customVar2List : List[String], yearList : List[Int], metricList : List[Int]) : SelectQuery[HourlyUaPrtnEntryCv1Cv2ClstCv3TableAccessor, HourlyUaPrtnEntryCv1Cv2ClstCv3Row, Unlimited, Unordered, Unspecified, Chainned, HNil] = {
