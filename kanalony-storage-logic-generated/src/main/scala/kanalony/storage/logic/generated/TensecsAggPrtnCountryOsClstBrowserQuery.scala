package kanalony.storage.logic.generated
    ...
    class TensecsAggPrtnCountryOsClstBrowserQuery extends QueryBase[TensecsAggPrtnCountryOsClstBrowserQueryParams, TensecsAggPrtnCountryOsClstBrowserRow] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): TensecsAggPrtnCountryOsClstBrowserQueryParams = {
        ...
        TensecsAggPrtnCountryOsClstBrowserQueryParams(params.start, params.end, partner_id,country,operating_system, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: TensecsAggPrtnCountryOsClstBrowserQueryParams): Future[List[TensecsAggPrtnCountryOsClstBrowserRow]] = {
        val rawQueryResult = TensecsAggPrtnCountryOsClstBrowserTableAccessor.query(params.partnerIdList,params.countryList,params.operatingSystemList,params.metricList,params.days,params.startTime,params.endTime)
