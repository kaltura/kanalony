package kanalony.storage.logic.generated
    ...
    class MinutelyAggPrtnCv3ClstEntryQuery extends QueryBase[MinutelyAggPrtnCv3ClstEntryQueryParams, MinutelyAggPrtnCv3ClstEntryRow] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): MinutelyAggPrtnCv3ClstEntryQueryParams = {
        ...
        MinutelyAggPrtnCv3ClstEntryQueryParams(params.start, params.end, partner_id,custom_var3, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: MinutelyAggPrtnCv3ClstEntryQueryParams): Future[List[MinutelyAggPrtnCv3ClstEntryRow]] = {
        val rawQueryResult = MinutelyAggPrtnCv3ClstEntryTableAccessor.query(params.partnerIdList,params.customVar3List,params.days,params.metricList,params.startTime,params.endTime)
