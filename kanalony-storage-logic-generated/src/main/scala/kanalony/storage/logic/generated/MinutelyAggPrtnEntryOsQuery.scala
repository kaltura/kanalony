package kanalony.storage.logic.generated
    ...
    class MinutelyAggPrtnEntryOsQuery extends QueryBase[MinutelyAggPrtnEntryOsQueryParams, MinutelyAggPrtnEntryOsRow] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): MinutelyAggPrtnEntryOsQueryParams = {
        ...
        MinutelyAggPrtnEntryOsQueryParams(params.start, params.end, partner_id,entry_id,operating_system, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: MinutelyAggPrtnEntryOsQueryParams): Future[List[MinutelyAggPrtnEntryOsRow]] = {
        val rawQueryResult = MinutelyAggPrtnEntryOsTableAccessor.query(params.partnerIdList,params.entryIdList,params.operatingSystemList,params.metricList,params.days,params.startTime,params.endTime)
