package kanalony.storage.logic.generated
    ...
    class HourlyAggPrtnEntryCv1Cv2ClstCv3Query extends QueryBase[HourlyAggPrtnEntryCv1Cv2ClstCv3QueryParams, HourlyAggPrtnEntryCv1Cv2ClstCv3Row] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): HourlyAggPrtnEntryCv1Cv2ClstCv3QueryParams = {
        ...
        HourlyAggPrtnEntryCv1Cv2ClstCv3QueryParams(params.start, params.end, partner_id,entry_id,custom_var1,custom_var2, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: HourlyAggPrtnEntryCv1Cv2ClstCv3QueryParams): Future[List[HourlyAggPrtnEntryCv1Cv2ClstCv3Row]] = {
        val rawQueryResult = HourlyAggPrtnEntryCv1Cv2ClstCv3TableAccessor.query(params.partnerIdList,params.entryIdList,params.customVar1List,params.customVar2List,params.years,params.metricList,params.startTime,params.endTime)
