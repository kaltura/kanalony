package kanalony.storage.logic.generated
    ...
    class HourlyAggQuery extends QueryBase[HourlyAggQueryParams, HourlyAggRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: HourlyAggQueryParams): Future[List[HourlyAggRow]] = {
        val rawQueryResult = HourlyAggTableAccessor.query(params.partnerIdList,params.metricList,params.years,params.startTime,params.endTime)
