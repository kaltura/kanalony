package kanalony.storage.logic.generated
    ...
    class MinutelyAggClstCv2Query extends QueryBase[MinutelyAggClstCv2QueryParams, MinutelyAggClstCv2Row] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): MinutelyAggClstCv2QueryParams = {
        val (partner_id) = QueryParamsValidator.extractEqualityConstraintParams[Int]((Dimensions.partner), params)
        MinutelyAggClstCv2QueryParams(params.start, params.end, partner_id, params.metrics.map(_.name))
      }

      override def supportsUserDefinedMetrics = true

      private[logic] override def executeQuery(params: MinutelyAggClstCv2QueryParams): Future[List[MinutelyAggClstCv2Row]] = {
        val rawQueryResult = MinutelyAggClstCv2TableAccessor.query(params.partnerIdList,params.metricList,params.days,params.startTime,params.endTime)
