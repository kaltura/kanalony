package kanalony.storage.logic.generated
    ...
    class MinutelyAggPrtnEntryClstCountryCityQuery extends QueryBase[MinutelyAggPrtnEntryClstCountryCityQueryParams, MinutelyAggPrtnEntryClstCountryCityRow] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): MinutelyAggPrtnEntryClstCountryCityQueryParams = {
        ...
        MinutelyAggPrtnEntryClstCountryCityQueryParams(params.start, params.end, partner_id,entry_id, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: MinutelyAggPrtnEntryClstCountryCityQueryParams): Future[List[MinutelyAggPrtnEntryClstCountryCityRow]] = {
        val rawQueryResult = MinutelyAggPrtnEntryClstCountryCityTableAccessor.query(params.partnerIdList,params.entryIdList,params.metricList,params.days,params.startTime,params.endTime)
