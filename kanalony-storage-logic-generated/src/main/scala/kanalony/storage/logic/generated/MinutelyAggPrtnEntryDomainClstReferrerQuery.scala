package kanalony.storage.logic.generated
    ...
    class MinutelyAggPrtnEntryDomainClstReferrerQuery extends QueryBase[MinutelyAggPrtnEntryDomainClstReferrerQueryParams, MinutelyAggPrtnEntryDomainClstReferrerRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: MinutelyAggPrtnEntryDomainClstReferrerQueryParams): Future[List[MinutelyAggPrtnEntryDomainClstReferrerRow]] = {
        val rawQueryResult = MinutelyAggPrtnEntryDomainClstReferrerTableAccessor.query(params.partnerIdList,params.entryIdList,params.domainList,params.metricList,params.days,params.startTime,params.endTime)
