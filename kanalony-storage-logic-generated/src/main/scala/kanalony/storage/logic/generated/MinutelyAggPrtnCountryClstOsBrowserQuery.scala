package kanalony.storage.logic.generated
    ...
    class MinutelyAggPrtnCountryClstOsBrowserQuery extends QueryBase[MinutelyAggPrtnCountryClstOsBrowserQueryParams, MinutelyAggPrtnCountryClstOsBrowserRow] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): MinutelyAggPrtnCountryClstOsBrowserQueryParams = {
        ...
        MinutelyAggPrtnCountryClstOsBrowserQueryParams(params.start, params.end, partner_id,country, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: MinutelyAggPrtnCountryClstOsBrowserQueryParams): Future[List[MinutelyAggPrtnCountryClstOsBrowserRow]] = {
        val rawQueryResult = MinutelyAggPrtnCountryClstOsBrowserTableAccessor.query(params.partnerIdList,params.countryList,params.metricList,params.days,params.startTime,params.endTime)
