package kanalony.storage.logic.generated
    ...
    class MinutelyAggPrtnEntryCv1Cv2Cv3Query extends QueryBase[MinutelyAggPrtnEntryCv1Cv2Cv3QueryParams, MinutelyAggPrtnEntryCv1Cv2Cv3Row] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: MinutelyAggPrtnEntryCv1Cv2Cv3QueryParams): Future[List[MinutelyAggPrtnEntryCv1Cv2Cv3Row]] = {
        val rawQueryResult = MinutelyAggPrtnEntryCv1Cv2Cv3TableAccessor.query(params.partnerIdList,params.entryIdList,params.customVar1List,params.customVar2List,params.customVar3List,params.metricList,params.days,params.startTime,params.endTime)
