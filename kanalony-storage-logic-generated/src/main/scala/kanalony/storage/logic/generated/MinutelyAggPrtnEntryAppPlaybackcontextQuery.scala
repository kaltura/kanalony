package kanalony.storage.logic.generated
    ...
    class MinutelyAggPrtnEntryAppPlaybackcontextQuery extends QueryBase[MinutelyAggPrtnEntryAppPlaybackcontextQueryParams, MinutelyAggPrtnEntryAppPlaybackcontextRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: MinutelyAggPrtnEntryAppPlaybackcontextQueryParams): Future[List[MinutelyAggPrtnEntryAppPlaybackcontextRow]] = {
        val rawQueryResult = MinutelyAggPrtnEntryAppPlaybackcontextTableAccessor.query(params.partnerIdList,params.entryIdList,params.applicationList,params.playbackContextList,params.metricList,params.days,params.startTime,params.endTime)
