package kanalony.storage.logic.generated
    ...
    class HourlyAggPrtnPlaybackcontextClstEntryQuery extends QueryBase[HourlyAggPrtnPlaybackcontextClstEntryQueryParams, HourlyAggPrtnPlaybackcontextClstEntryRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: HourlyAggPrtnPlaybackcontextClstEntryQueryParams): Future[List[HourlyAggPrtnPlaybackcontextClstEntryRow]] = {
        val rawQueryResult = HourlyAggPrtnPlaybackcontextClstEntryTableAccessor.query(params.partnerIdList,params.playbackContextList,params.months,params.metricList,params.startTime,params.endTime)
