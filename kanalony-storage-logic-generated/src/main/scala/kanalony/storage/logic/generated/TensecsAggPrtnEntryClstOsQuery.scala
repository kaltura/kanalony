package kanalony.storage.logic.generated
    ...
    class TensecsAggPrtnEntryClstOsQuery extends QueryBase[TensecsAggPrtnEntryClstOsQueryParams, TensecsAggPrtnEntryClstOsRow] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): TensecsAggPrtnEntryClstOsQueryParams = {
        ...
        TensecsAggPrtnEntryClstOsQueryParams(params.start, params.end, partner_id,entry_id, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: TensecsAggPrtnEntryClstOsQueryParams): Future[List[TensecsAggPrtnEntryClstOsRow]] = {
        val rawQueryResult = TensecsAggPrtnEntryClstOsTableAccessor.query(params.partnerIdList,params.entryIdList,params.metricList,params.days,params.startTime,params.endTime)
