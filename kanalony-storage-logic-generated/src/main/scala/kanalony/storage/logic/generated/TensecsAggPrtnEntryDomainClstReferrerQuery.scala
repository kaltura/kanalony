package kanalony.storage.logic.generated
    ...
    class TensecsAggPrtnEntryDomainClstReferrerQuery extends QueryBase[TensecsAggPrtnEntryDomainClstReferrerQueryParams, TensecsAggPrtnEntryDomainClstReferrerRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: TensecsAggPrtnEntryDomainClstReferrerQueryParams): Future[List[TensecsAggPrtnEntryDomainClstReferrerRow]] = {
        val rawQueryResult = TensecsAggPrtnEntryDomainClstReferrerTableAccessor.query(params.partnerIdList,params.entryIdList,params.domainList,params.metricList,params.days,params.startTime,params.endTime)
