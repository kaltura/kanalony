package kanalony.storage.logic.generated
    ...
    class HourlyAggPrtnEntryClstDeviceQuery extends QueryBase[HourlyAggPrtnEntryClstDeviceQueryParams, HourlyAggPrtnEntryClstDeviceRow] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): HourlyAggPrtnEntryClstDeviceQueryParams = {
        ...
        HourlyAggPrtnEntryClstDeviceQueryParams(params.start, params.end, partner_id,entry_id, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: HourlyAggPrtnEntryClstDeviceQueryParams): Future[List[HourlyAggPrtnEntryClstDeviceRow]] = {
        val rawQueryResult = HourlyAggPrtnEntryClstDeviceTableAccessor.query(params.partnerIdList,params.entryIdList,params.metricList,params.years,params.startTime,params.endTime)
