package kanalony.storage.logic.generated
    ...
    class TensecsAggPrtnEntryClstReferrerQuery extends QueryBase[TensecsAggPrtnEntryClstReferrerQueryParams, TensecsAggPrtnEntryClstReferrerRow] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): TensecsAggPrtnEntryClstReferrerQueryParams = {
        ...
        TensecsAggPrtnEntryClstReferrerQueryParams(params.start, params.end, partner_id,entry_id, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: TensecsAggPrtnEntryClstReferrerQueryParams): Future[List[TensecsAggPrtnEntryClstReferrerRow]] = {
        val rawQueryResult = TensecsAggPrtnEntryClstReferrerTableAccessor.query(params.partnerIdList,params.entryIdList,params.metricList,params.days,params.startTime,params.endTime)
