package kanalony.storage.logic.generated
    ...
    class MinutelyAggPrtnEntryCountryCityQuery extends QueryBase[MinutelyAggPrtnEntryCountryCityQueryParams, MinutelyAggPrtnEntryCountryCityRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: MinutelyAggPrtnEntryCountryCityQueryParams): Future[List[MinutelyAggPrtnEntryCountryCityRow]] = {
        val rawQueryResult = MinutelyAggPrtnEntryCountryCityTableAccessor.query(params.partnerIdList,params.entryIdList,params.countryList,params.cityList,params.metricList,params.days,params.startTime,params.endTime)
