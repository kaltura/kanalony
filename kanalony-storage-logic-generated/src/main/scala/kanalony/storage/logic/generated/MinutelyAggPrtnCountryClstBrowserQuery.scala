package kanalony.storage.logic.generated
    ...
    class MinutelyAggPrtnCountryClstBrowserQuery extends QueryBase[MinutelyAggPrtnCountryClstBrowserQueryParams, MinutelyAggPrtnCountryClstBrowserRow] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): MinutelyAggPrtnCountryClstBrowserQueryParams = {
        ...
        MinutelyAggPrtnCountryClstBrowserQueryParams(params.start, params.end, partner_id,country, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: MinutelyAggPrtnCountryClstBrowserQueryParams): Future[List[MinutelyAggPrtnCountryClstBrowserRow]] = {
        val rawQueryResult = MinutelyAggPrtnCountryClstBrowserTableAccessor.query(params.partnerIdList,params.countryList,params.metricList,params.days,params.startTime,params.endTime)
