package kanalony.storage.logic.generated
    ...
    class HourlyAggPrtnDeviceClstOsQuery extends QueryBase[HourlyAggPrtnDeviceClstOsQueryParams, HourlyAggPrtnDeviceClstOsRow] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): HourlyAggPrtnDeviceClstOsQueryParams = {
        ...
        HourlyAggPrtnDeviceClstOsQueryParams(params.start, params.end, partner_id,device, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: HourlyAggPrtnDeviceClstOsQueryParams): Future[List[HourlyAggPrtnDeviceClstOsRow]] = {
        val rawQueryResult = HourlyAggPrtnDeviceClstOsTableAccessor.query(params.partnerIdList,params.deviceList,params.metricList,params.years,params.startTime,params.endTime)
