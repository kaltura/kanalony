package kanalony.storage.logic.generated
    ...
    class TensecsAggPrtnEntryOsQuery extends QueryBase[TensecsAggPrtnEntryOsQueryParams, TensecsAggPrtnEntryOsRow] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): TensecsAggPrtnEntryOsQueryParams = {
        ...
        TensecsAggPrtnEntryOsQueryParams(params.start, params.end, partner_id,entry_id,operating_system, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: TensecsAggPrtnEntryOsQueryParams): Future[List[TensecsAggPrtnEntryOsRow]] = {
        val rawQueryResult = TensecsAggPrtnEntryOsTableAccessor.query(params.partnerIdList,params.entryIdList,params.operatingSystemList,params.metricList,params.days,params.startTime,params.endTime)
