package kanalony.storage.logic.generated
    ...
    class HourlyAggPrtnCv1Cv2ClstEntryQuery extends QueryBase[HourlyAggPrtnCv1Cv2ClstEntryQueryParams, HourlyAggPrtnCv1Cv2ClstEntryRow] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): HourlyAggPrtnCv1Cv2ClstEntryQueryParams = {
        ...
        HourlyAggPrtnCv1Cv2ClstEntryQueryParams(params.start, params.end, partner_id,custom_var1,custom_var2, params.metrics.map(_.name))
      }
      ...
      private[logic] override def executeQuery(params: HourlyAggPrtnCv1Cv2ClstEntryQueryParams): Future[List[HourlyAggPrtnCv1Cv2ClstEntryRow]] = {
        val rawQueryResult = HourlyAggPrtnCv1Cv2ClstEntryTableAccessor.query(params.partnerIdList,params.customVar1List,params.customVar2List,params.months,params.metricList,params.startTime,params.endTime)
