package kanalony.storage.logic.generated
    ...
    class TensecsAggClstEntryQuery extends QueryBase[TensecsAggClstEntryQueryParams, TensecsAggClstEntryRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: TensecsAggClstEntryQueryParams): Future[List[TensecsAggClstEntryRow]] = {
        val rawQueryResult = TensecsAggClstEntryTableAccessor.query(params.partnerIdList,params.days,params.metricList,params.startTime,params.endTime)
