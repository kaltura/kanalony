package kanalony.storage.logic.generated
    ...
    class HourlyAggClstCv1Query extends QueryBase[HourlyAggClstCv1QueryParams, HourlyAggClstCv1Row] with IUserActivityQuery {
      private[logic] override def extractParams(params: QueryParams): HourlyAggClstCv1QueryParams = {
        val (partner_id) = QueryParamsValidator.extractEqualityConstraintParams[Int]((Dimensions.partner), params)
        HourlyAggClstCv1QueryParams(params.start, params.end, partner_id, params.metrics.map(_.name))
      }

      override def supportsUserDefinedMetrics = true

      private[logic] override def executeQuery(params: HourlyAggClstCv1QueryParams): Future[List[HourlyAggClstCv1Row]] = {
        val rawQueryResult = HourlyAggClstCv1TableAccessor.query(params.partnerIdList,params.years,params.metricList,params.startTime,params.endTime)
