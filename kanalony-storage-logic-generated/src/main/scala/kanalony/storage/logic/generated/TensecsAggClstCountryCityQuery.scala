package kanalony.storage.logic.generated
    ...
    class TensecsAggClstCountryCityQuery extends QueryBase[TensecsAggClstCountryCityQueryParams, TensecsAggClstCountryCityRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: TensecsAggClstCountryCityQueryParams): Future[List[TensecsAggClstCountryCityRow]] = {
        val rawQueryResult = TensecsAggClstCountryCityTableAccessor.query(params.partnerIdList,params.metricList,params.days,params.startTime,params.endTime)
