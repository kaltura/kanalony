package kanalony.storage.logic.generated
    ...
    class TensecsAggClstAppQuery extends QueryBase[TensecsAggClstAppQueryParams, TensecsAggClstAppRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: TensecsAggClstAppQueryParams): Future[List[TensecsAggClstAppRow]] = {
        val rawQueryResult = TensecsAggClstAppTableAccessor.query(params.partnerIdList,params.metricList,params.days,params.startTime,params.endTime)
