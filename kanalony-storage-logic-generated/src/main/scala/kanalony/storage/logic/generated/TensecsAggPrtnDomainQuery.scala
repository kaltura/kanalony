package kanalony.storage.logic.generated
    ...
    class TensecsAggPrtnDomainQuery extends QueryBase[TensecsAggPrtnDomainQueryParams, TensecsAggPrtnDomainRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: TensecsAggPrtnDomainQueryParams): Future[List[TensecsAggPrtnDomainRow]] = {
        val rawQueryResult = TensecsAggPrtnDomainTableAccessor.query(params.partnerIdList,params.domainList,params.metricList,params.days,params.startTime,params.endTime)
