package kanalony.storage.logic.generated
    ...
    class MinutelyAggPrtnEntryOsClstBrowserQuery extends QueryBase[MinutelyAggPrtnEntryOsClstBrowserQueryParams, MinutelyAggPrtnEntryOsClstBrowserRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: MinutelyAggPrtnEntryOsClstBrowserQueryParams): Future[List[MinutelyAggPrtnEntryOsClstBrowserRow]] = {
        val rawQueryResult = MinutelyAggPrtnEntryOsClstBrowserTableAccessor.query(params.partnerIdList,params.entryIdList,params.operatingSystemList,params.metricList,params.days,params.startTime,params.endTime)
