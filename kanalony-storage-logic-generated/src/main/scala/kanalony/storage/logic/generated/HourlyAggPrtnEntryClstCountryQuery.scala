package kanalony.storage.logic.generated
    ...
    class HourlyAggPrtnEntryClstCountryQuery extends QueryBase[HourlyAggPrtnEntryClstCountryQueryParams, HourlyAggPrtnEntryClstCountryRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: HourlyAggPrtnEntryClstCountryQueryParams): Future[List[HourlyAggPrtnEntryClstCountryRow]] = {
        val rawQueryResult = HourlyAggPrtnEntryClstCountryTableAccessor.query(params.partnerIdList,params.entryIdList,params.metricList,params.years,params.startTime,params.endTime)
