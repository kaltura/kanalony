package kanalony.storage.logic.generated
    ...
    class MinutelyAggPrtnEntryCv1Cv2Query extends QueryBase[MinutelyAggPrtnEntryCv1Cv2QueryParams, MinutelyAggPrtnEntryCv1Cv2Row] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: MinutelyAggPrtnEntryCv1Cv2QueryParams): Future[List[MinutelyAggPrtnEntryCv1Cv2Row]] = {
        val rawQueryResult = MinutelyAggPrtnEntryCv1Cv2TableAccessor.query(params.partnerIdList,params.entryIdList,params.customVar1List,params.customVar2List,params.metricList,params.days,params.startTime,params.endTime)
