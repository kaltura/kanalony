package kanalony.storage.logic.generated
    ...
    class MinutelyAggPrtnEntryCountryClstOsQuery extends QueryBase[MinutelyAggPrtnEntryCountryClstOsQueryParams, MinutelyAggPrtnEntryCountryClstOsRow] with IUserActivityQuery {
      ...
      private[logic] override def executeQuery(params: MinutelyAggPrtnEntryCountryClstOsQueryParams): Future[List[MinutelyAggPrtnEntryCountryClstOsRow]] = {
        val rawQueryResult = MinutelyAggPrtnEntryCountryClstOsTableAccessor.query(params.partnerIdList,params.entryIdList,params.countryList,params.metricList,params.days,params.startTime,params.endTime)
