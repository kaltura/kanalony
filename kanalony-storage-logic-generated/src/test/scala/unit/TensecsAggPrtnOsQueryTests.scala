...
class TensecsAggPrtnOsQueryTests extends FunSpec with MockFactory with BeforeAndAfterEach with ScalaFutures with Matchers with Inspectors {
  ...
  describe("TensecsAggPrtnOsTests tests") {
    ...
    it("Should query table with the correct parameters")({
      configureStub(List(1,2),List(1,2),List("play"),List(19700101),new DateTime(1), new DateTime(1000),
        List(TensecsAggPrtnOsRow(1,1,"play",19700101, new DateTime(1),5)))
    ...
    it("Should aggregate correctly when there are no group by columns (i.e. cross-partner)")({
      configureStub(List(1,2),List(1,2),List("play"),List(19700101),new DateTime(1), new DateTime(1000),
        List(TensecsAggPrtnOsRow(1,1,"play",19700101, new DateTime(1),5),
             TensecsAggPrtnOsRow(2,1,"play",19700101, new DateTime(1),1)))
    ...
    it("Should aggregate correctly over several metrics")({
      configureStub(List(1),List(1),List("play","playerImpression"),List(19700101),new DateTime(1), new DateTime(1000),
        List(TensecsAggPrtnOsRow(1,1,"play",19700101, new DateTime(1).plusMinutes(5),1),
          TensecsAggPrtnOsRow(1,1,"play",19700101, new DateTime(1).plusMinutes(5),2),
          TensecsAggPrtnOsRow(1,1,"playerImpression",19700101, new DateTime(1),3),
          TensecsAggPrtnOsRow(1,1,"playerImpression",19700101, new DateTime(1).plusHours(1),4)))
    ...
    it("Should aggregate correctly over max-logic metric")({
      configureStub(List(1),List(1),List("peakView"),List(19700101),new DateTime(1), new DateTime(1000),
        List(TensecsAggPrtnOsRow(1,1,"peakView",19700101, new DateTime(1).plusMinutes(1),1),
          TensecsAggPrtnOsRow(1,1,"peakView",19700101, new DateTime(1).plusMinutes(2),200),
          TensecsAggPrtnOsRow(1,1,"peakView",19700101, new DateTime(1).plusMinutes(3),3),
          TensecsAggPrtnOsRow(1,1,"peakView",19700101, new DateTime(1).plusHours(4),4)))
