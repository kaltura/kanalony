...
lazy val `kanalony-storage-logic-generated` = (project in file(".")).
  settings(
    name := "kanalony-storage-logic-generated",
    version := "1.0",
    scalaVersion := "2.11.7",
  ...
  ).dependsOn(`kanalony-storage-access`,`kanalony-model`,`kanalony-storage-logic-core`)