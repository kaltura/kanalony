...
object DbClientFactory {
  ...
  object hourly_user_activity_prtn_entry_clst_country extends hourly_ua_prtn_entry_clst_countryTableAccessor with connector.Connector
  object hourly_user_activity_prtn_entry extends hourly_ua_prtn_entryTableAccessor with connector.Connector
  object hourly_user_activity_clst_entry extends hourly_ua_clst_entryTableAccessor with connector.Connector
