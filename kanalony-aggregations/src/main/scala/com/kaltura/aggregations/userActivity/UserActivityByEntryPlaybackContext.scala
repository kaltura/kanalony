...
import com.kaltura.aggregations.keys.UserActivityEntryPlaybackContextKey
...
object HourlyUserActivityByEntryPlaybackContext extends UserActivityByEntryPlaybackContext with IAggregateHourly {
  override lazy val tableMetadata: Map[String, SomeColumns] = Map(
    ...
    "hourly_ua_prtn_playback_context_clst_entry" -> toSomeColumns(columns :+ ("month", "month"))
  )
}
...
object MinutelyUserActivityByEntryPlaybackContext extends UserActivityByEntryPlaybackContext with IAggregateMinutely {
  override lazy val tableMetadata: Map[String, SomeColumns] = Map(
    ...
    "minutely_ua_prtn_playback_context_clst_entry" -> toSomeColumns(columns :+ ("day", "day"))
  )
}
...
case class EntryPlaybackContextRes(partnerId: Int, entryId: String, metric: Int, year: Int, month: Int, day: Int, time: DateTime, playbackContext: String, value: Long)
