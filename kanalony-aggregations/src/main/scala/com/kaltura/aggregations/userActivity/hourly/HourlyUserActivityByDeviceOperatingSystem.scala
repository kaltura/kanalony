...
import kanalony.storage.generated.hourly_ua_prtn_device_osRow

object HourlyUserActivityByDeviceOperatingSystem extends BaseUserActivityAggregation[UserActivityDeviceOperatingSystemKey, hourly_ua_prtn_device_osRow] with IAggregateHourly with Serializable {
  ...
  override def toRow(pair: (UserActivityDeviceOperatingSystemKey, Long)): hourly_ua_prtn_device_osRow = hourly_ua_prtn_device_osRow(pair._1.partnerId, pair._1.device, pair._1.operatingSystem, pair._1.metric, pair._1.time.getYear, pair._1.time, pair._2)
}
