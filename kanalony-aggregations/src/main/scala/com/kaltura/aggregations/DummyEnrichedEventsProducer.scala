...
object DummyEnrichedEventsProducer extends App{
  ...
  def pushTestEvents() = {
    ...
    var i = 0
    for( i <- 1 to 1){
      playerEvent1 = EnrichedPlayerEvent(eventType = 3, eventTime = DateTime.now(), partnerId = 1, entryId = "entry1", playbackType = "Live", location = Location(country = "US", city = "NewYork"), userAgent = UserAgent(device = Device.COMPUTER, operatingSystem = OperatingSystem.WINDOWS_10, browser = Browser.CHROME46), urlParts = UrlParts(domain = "www.google.com", canonicalUrl = "www.google.com/a_123", originalUrl = "www.google.com/a_123"), application = "app1", customVar1 = "R&D", customVar2 = "Backend", playbackContext = "123456", customVar3 = "a")
      ...
      playerEvent1 = EnrichedPlayerEvent(eventType = 3, eventTime = DateTime.now(), partnerId = 1, entryId = "entry3", playbackType = "Live", location = Location(country = "US", city = "NewYork"), userAgent = UserAgent(device = Device.COMPUTER, operatingSystem = OperatingSystem.WINDOWS_10, browser = Browser.CHROME46), urlParts = UrlParts(domain = "www.google.com", canonicalUrl = "www.google.com/a_123", originalUrl = "www.google.com/a_123"), application = "app1", customVar1 = "R&D", customVar2 = "Live", playbackContext = "98765", customVar3 = "b")
      playerEvent2 = EnrichedPlayerEvent(eventType = 99, eventTime = DateTime.now(), partnerId = 1, entryId = "entry3", playbackType = "Live", location = Location(country = "US", city = "NewYork"), userAgent = UserAgent(device = Device.COMPUTER, operatingSystem = OperatingSystem.WINDOWS_10, browser = Browser.CHROME46), urlParts = UrlParts(domain = "www.google.com", canonicalUrl = "www.google.com/a_123", originalUrl = "www.google.com/a_123"), application = "app1", customVar1 = "R&D", customVar2 = "Live", playbackContext = "98765", customVar3 = "b")
