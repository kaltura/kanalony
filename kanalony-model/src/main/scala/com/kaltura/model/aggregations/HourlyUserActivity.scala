...
case class HourlyPartnerPlaybackContext(partnerId: Int, metric: Int, year: Int, hour: DateTime, playbackContext: String, value: Long)
case class HourlyPartnerApplicationPlaybackContext(partnerId: Int, metric: Int, year: Int, hour: DateTime, application: String, playbackContext: String, value: Long)
...
case class HourlyEntryPlaybackContext(partnerId: Int, entryId: String, metric: Int, year: Int, hour: DateTime, playbackContext: String, value: Long)
case class HourlyEntryApplicationPlaybackContext(partnerId: Int, entryId: String, metric: Int, year: Int, hour: DateTime, application: String, playbackContext: String, value: Long)
