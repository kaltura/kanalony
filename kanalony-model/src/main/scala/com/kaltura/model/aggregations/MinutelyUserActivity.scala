...
case class MinutelyPartnerUserActivity(partnerId: Int, eventType: Int, minute: DateTime, count: Long)
case class MinutelyPartnerEntry(partnerId: Int, entryId: String, eventType: Int, minute: DateTime, count: Long)
